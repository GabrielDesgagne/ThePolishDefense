...
public class Grabber : Hand
{
    ...
    public void DistanceGrabBegin()
    {
        if(pointedObject)
        {
            ...
            Debug.Log(Vector3.Distance(headAnchor.transform.position, pointedObject.transform.position));
    ...
    public void CastRay()
    {
        ...
        if (Physics.SphereCast(transform.position, 0.01f, transform.forward, out rayHit, 1000, LayerMask.GetMask("Interact"))) //TODO Change layer to fit name
        {
            ...
            if (pointedObject != null)
                pointedObject.Pointed(false, this);
            ...
            // Will call this every frame. This could be optimised
            pointedObject.Pointed(true, this);
        }
